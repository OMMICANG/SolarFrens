 ...
 // Auto-toggle back to dark mode after 5 seconds
  ...
  return (
    ...
    <div className="menu">
        ...
        <div className={`menu-icon ${currentPage === 'bot' ? 'active' : ''}`} onClick={() => handleMenuIconClick(3)}>
